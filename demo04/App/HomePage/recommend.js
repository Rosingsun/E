  ...
  render() {
      ...
      if (id % 2 == 0 & choice == 1) {
        return (
          <View style={[styles.showContainer]}>
            {/* 图片框 */}
            <Image style={{ height: 120, width: '100%', borderTopLeftRadius: 3, borderTopRightRadius: 3 }} source={{ uri: showUserImg }}
              onPress={()=>{
        ...
        <View style={[styles.showContainer]}>
          {/* 图片框 */}
          <Image style={{ height: 100, width: '100%', borderTopLeftRadius: 3, borderTopRightRadius: 3 }} source={{ uri: showUserImg }}
    ...
    return (
      <View style={{ backgroundColor: "#EFEFEF", borderRadius: 200, }}>
        <View style={{ flexDirection: "row", width: "94%", marginLeft: '3%',backgroundColor:"red" }}>
          {/* 左边这一侧的用户商品信息 */}
